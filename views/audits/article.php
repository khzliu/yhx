    ...
    $this->registerCssFile('/css/audits.css'); 
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-12">
                    <ol class="breadcrumb">
                      ...
                      <li><a href="?r=audits/index">验厂咨询</a></li>
                      <li><a href="?r=audits/index&type=<?php echo $type[0]; ?>"><?php echo $type[1]; ?></a></li>
            ...
            <div class="col-xs-6 col-sm-3" id="sidebar" role="navigation">
              <div class="list-group">
                  <?php
                  foreach ($audits->getGroupItems() as $tempitem){
                      if($tempitem[0] === $audits->getItem()[0]){
                          echo '<a href="?r=audits/index&type=' . $tempitem[0] . '" class="list-group-item active">' . $tempitem[1] . '</a>';
                      }else{
                          echo '<a href="?r=audits/index&type=' . $tempitem[0] . '" class="list-group-item">' . $tempitem[1] . '</a>';
                      }
                  }
                  ?>
              </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="bg-info col-md-12 text-left"><font color='blue'>上一篇：</font>
                        ...
                        if($previousArticle==null)
                        {
                            ...
                            echo '<a href="?r=audits/article&type=' . $previousArticle->type . '&id=' . $previousArticle->id . '">' . $previousArticle->title . '</a>';
                        }
                        ?>
                        </div>
                    ...
                    if($nextArticle==null)
                        {
                            ...
                            echo '<a href="?r=audits/article&type=' . $nextArticle->type . '&id=' . $nextArticle->id . '">' . $nextArticle->title . '</a>';
                        }
                       ?></div>
                <div>
            </div>
